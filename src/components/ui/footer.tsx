...
export function Footer() {
  const socialLinks = [
    {
      name: "Instagram",
      href: "https://www.instagram.com/nucleocr/",
      icon: (
    ...
    {
      name: "Facebook",
      href: "https://www.facebook.com/soynucleo",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Spotify",
      href: "https://open.spotify.com/show/3YPKu9IoV5hX5cigHbVU2r?si=7721ab8cd50e43ae",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-slate-300 mb-6 max-w-md">
              ...
              donde se valoren la singularidad, la vida en comunidad y el amor incondicional.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/equipos" className="text-slate-300 hover:text-white transition-colors">
                  Equipos
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-300">
              <li>
                <span className="block text-sm">Servicios Dominicales</span>
                <span className="text-white">10:00 AM y 6:00 PM</span>
              </li>
              <li>
